...
namespace MyOwnWorld;

use MyOwnWorld\AI\ZombieAI;
...
//	public $Skeleton= [];	
	...
	public function onEnable() {
		...
		//注册自定义实体
		Entity::registerEntity('MyOwnWorld\Entities\Pig');//猪
		Entity::registerEntity('MyOwnWorld\Entities\Sheep');//羊
		Entity::registerEntity('MyOwnWorld\Entities\Cow'); //牛
		Entity::registerEntity('MyOwnWorld\Entities\Chicken');//鸡
		...
		//添加支持的物品
		Item::addCreativeItem(Item::get(Item::SPAWN_EGG, 38)); //末影人
		Item::addCreativeItem(Item::get(Item::SPAWN_EGG, 33)); //苦力怕
		Item::addCreativeItem(Item::get(Item::SPAWN_EGG, 34)); //骷髅
		Item::addCreativeItem(Item::get(Item::SPAWN_EGG, 12)); //猪
		Item::addCreativeItem(Item::get(Item::SPAWN_EGG, 13)); //羊
		Item::addCreativeItem(Item::get(Item::SPAWN_EGG, 11)); //牛
		Item::addCreativeItem(Item::get(Item::SPAWN_EGG, 10)); //鸡
	...
	public function PlayerItemHeld(PlayerItemHeldEvent $event) {
		...
		if ($itemid == 288) {
			$player->sendMessage($this->getLight($player->getPosition()));
		}
	}
